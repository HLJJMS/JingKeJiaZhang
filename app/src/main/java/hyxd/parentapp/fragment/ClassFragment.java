...
public class ClassFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_class, container, false);

        webView = contentView.findViewById(R.id.web);
...
//        url = "http://192.168.0.141/jingkeOnlineWeChat/webHome/";
        url = "http://wxt.jingke.net/web/jingkeWEB/webHome/";
...
//        webView.loadData("nihao","text/html; charset= UTF-8",null);
