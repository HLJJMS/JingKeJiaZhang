...
import hyxd.parentapp.util.ConnectionDetector;
...
public class CommonWay {
    ...
    public static String getHtmlData(String bodyHTML) {
        String head = "<head>" +
                ...
                "<style>img{max-width: 100%; width:auto; height:auto;}</style>" + "<style>p *{font-size:16px !important;line-height:130%}</style>" +
                "</head>";
    ...
    public static String jsoup4(String str) {
        ...
        if (p.size() != 0) {//
            for (Element e_p : p) {
                Log.e("xiaoma", e_p.toString());
                e_p.attr("onclick", "this.style.overflow='auto';this.style.whiteSpace='normal';this.style.width='auto';");//设置字体的大小颜色行间距
                e_p.attr("style", "font-size:16px;width:600px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin:0;padding:0;"); //设置字体的大小
//                return getHtmlData2(e_p.toString());
            }
        }
        return getHtmlData2(doc.toString());
    }
