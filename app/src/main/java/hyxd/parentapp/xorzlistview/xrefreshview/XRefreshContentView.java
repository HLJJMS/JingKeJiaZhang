package hyxd.parentapp.xorzlistview.xrefreshview;
...
import hyxd.parentapp.xorzlistview.xrefreshview.listener.OnBottomLoadMoreTime;
import hyxd.parentapp.xorzlistview.xrefreshview.listener.OnTopRefreshTime;
import hyxd.parentapp.xorzlistview.xrefreshview.recyclerview.BaseRecyclerAdapter;
import hyxd.parentapp.xorzlistview.xrefreshview.recyclerview.XSpanSizeLookup;
import hyxd.parentapp.xorzlistview.xrefreshview.utils.Utils;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime,
    ...
    /**
     * ����Զ�ˢ�£�����container, container!=null�����б���ײ��Զ����ظ���
     *
     * @param container
     */
    ...
    private void setRecyclerViewScrollListener() {
        ...
        if (!(recyclerView.getAdapter() instanceof BaseRecyclerAdapter)) {
            throw new RuntimeException("Recylerview��adapter��̳� BaseRecyclerAdapter");
        }
