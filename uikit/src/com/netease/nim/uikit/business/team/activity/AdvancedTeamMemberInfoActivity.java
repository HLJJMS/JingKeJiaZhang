...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        chatBtn = (Button) findViewById(R.id.begin_chat);
    ...
    private void onChat() {
        Log.i(TAG, "onChat");
        NimUIKit.startP2PSession(AdvancedTeamMemberInfoActivity.this, account, null);
    }
